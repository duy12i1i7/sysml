...
Duration & mean 7.404 s, min 5.502 s, max 9.006 s \\
Role switches & 0 total \\
Minimum separation & min 0.765 m, mean 0.949 m \\
\texttt{/robot1} path & mean 1.238 m \\
\texttt{/robot2} path & mean 0.858 m \\
